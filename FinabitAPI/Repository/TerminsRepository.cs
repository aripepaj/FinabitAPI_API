...
namespace AutoBit_WebInvoices.Models
{
    public class TerminsRepository
    {
        ...
        public void Insert(Termins cls)
        {
            ...
            param = new SqlParameter("@BeginningDate", System.Data.SqlDbType.SmallDateTime);
            param.Direction = ParameterDirection.Input;
            ...
            param = new SqlParameter("@CashJournalPOSID", System.Data.SqlDbType.Int);
            param.Direction = ParameterDirection.Input;
            ...
            param = new SqlParameter("@JournalInitialState", System.Data.SqlDbType.Decimal);
            param.Direction = ParameterDirection.Input;
        ...
        public void Update(Termins cls)
        {
            ...
            param = new SqlParameter("@EndingDate", System.Data.SqlDbType.SmallDateTime);
            param.Direction = ParameterDirection.Input;
            param.Value = DateTime.Now;
            cmd.Parameters.Add(param);
            ...
            param = new SqlParameter("@IsSynchronised", System.Data.SqlDbType.Bit);
            param.Direction = ParameterDirection.Input;
        ...
        public DataTable SelectAllTable(bool IsCombo)
        {
            ...
            param = new SqlParameter("@IsCombo", System.Data.SqlDbType.Bit);
            param.Direction = ParameterDirection.Input;
            param.Value = IsCombo;
            cmd.Parameters.Add(param);
        ...
        public DataTable RealisationsList(string FromDate, string ToDate, int Mode, string Import)
        {
            ...
            param = new SqlParameter("@Import", System.Data.SqlDbType.VarChar);
            param.Direction = ParameterDirection.Input;
            param.Value = Import;
            cmd.Parameters.Add(param);
        ...
        public DataTable TerminReportBatch(DataTable Termins, bool IsReprezentacion)
        {
            ...
            param = new SqlParameter("@Termins", System.Data.SqlDbType.Structured);
            param.Direction = ParameterDirection.Input;
            param.Value = Termins;
            cmd.Parameters.Add(param);


            param = new SqlParameter("@IsReprezentacion", System.Data.SqlDbType.Bit);
            param.Direction = ParameterDirection.Input;
        ...
        public void TerminSyncWithTransferDB(Termins cls, Boolean DeletePrevious)
        {
            SqlConnection cnn = GlobalRepository.GetConnection();
            ...
            param = new SqlParameter("@DeletePrevious", System.Data.SqlDbType.Bit);
            param.Direction = ParameterDirection.Input;
