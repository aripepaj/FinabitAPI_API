       ...
       // private ItemRepository _itemRepository;
        ...
        public ActionResult<List<Items2>> GetItems([FromBody] List<Items> c)
        {
            ...
            foreach (var item in distinctList)
            {
                ...
                rezultati.Add(
                    new Items2 { Shifra = item.Shifra, Emertimi = item.Emertimi, Cmimi = item.Cmimi, Lokacioni = locations, Sasia = sumQuantity, Shifra_e_katalogut = item.Shifra_e_katalogut, Shifra_prodhuesit = item.Shifra_prodhuesit,Prodhuesi = item.Prodhuesi,Lokacionet = listaLocations });
        ...
        public ActionResult<List<Items2>> GetItems2([FromBody] List<string> c)
        {
            ...
            foreach (var item in distinctList)
            {
                ...
                rezultati.Add(
                    new Items2 { Shifra = item.Shifra, Emertimi = item.Emertimi, Cmimi = item.Cmimi, Lokacioni = locations, Sasia = sumQuantity, Shifra_e_katalogut = item.Shifra_e_katalogut, Shifra_prodhuesit = item.Shifra_prodhuesit,Prodhuesi = item.Prodhuesi,Lokacionet=listaLokacionet });
        ...
        public ActionResult<List<Items2>> GetItemsByProducer([FromBody] ItemsProducer producer)
        {
            ...
            foreach (var item in distinctList)
            {
                ...
                rezultati.Add(
                    new Items2 { Shifra = item.Shifra, Emertimi = item.Emertimi, Cmimi = item.Cmimi, Lokacioni = locations, Sasia = sumQuantity, Shifra_prodhuesit = item.Shifra_prodhuesit, Prodhuesi = item.Prodhuesi, Lokacionet = listaLocations});
        ...
        public ActionResult<List<Items2>> GetItemsByItemID([FromQuery] string ItemID, [FromQuery] string Email)
        {
            ...
            foreach (var item in distinctList)
            {
                ...
                rezultati.Add(
                    new Items2 { Shifra = item.Shifra, Emertimi = item.Emertimi, Cmimi = item.Cmimi, Lokacioni = locations, Sasia = sumQuantity, Shifra_prodhuesit = item.Shifra_prodhuesit, Prodhuesi = item.Prodhuesi, Lokacionet = listaLocations,Cmimi2=item.Cmimi2 });
        ...
        public ActionResult<PaginationResult<Items2>> GetItemsByProducer2([FromBody] ItemsProducer2 producer)
        {
            ...
            return Paginate(rezultati,producer.PageNumber,30);
        }
